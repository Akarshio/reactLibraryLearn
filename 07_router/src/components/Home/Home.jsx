...
export default function Home() {
    return (
        <div className="mx-auto w-full max-w-7xl">
            <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16 bg-orange-50">
                ...
                <div className="absolute inset-0 w-full sm:my-20 sm:pt-1 pt-12 h-full flex items-center">
                    <img
                        className="w-96 rounded-xl opacity-90"
